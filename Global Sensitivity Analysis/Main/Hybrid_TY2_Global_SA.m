...
for niter = 1:N
    ...
    label_list = ["X mRNA"; "Y mRNA"; "Z mRNA"; "X:Y"; "Y_prime"; ...
        "Pz_rep"; "X:Z"; "GFP"];
    
    
    delta_t = diff(All_t);
    t_increment = delta_t(1); %%%% time interval in min.
    zact = All_x(:,8); %%% GFP output
...
save('Kinetic_Hybrid_TY2_Global_SA_Results.mat','Sample','t_rise', 'ratio','pulse_width','pulse_height',...
