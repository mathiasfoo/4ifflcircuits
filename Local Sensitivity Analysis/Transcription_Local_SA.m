...
for k = 1:12 %%% Including a Loop for each Variable %%%
    ...
    for ii = [0.001:0.001:0.009 0.01:0.01:0.09 0.1:0.1:0.9 1:1:9 10:10:90 100:100:1000]
        ...
        label_list = ["X mRNA"; "Y mRNA"; "Z mRNA"; "Pz rep"; "GFP"; "Py act"; "Pz act"];
        ...
        ylabel('GFP Output')
        hold on
        plot(All_t,All_x(:,5),'LineWidth',2)
        title(['\',paralist{k}])
        ...
        if locmax_gfp*delta_t(1) <= t_cutoff*delta_t(1) && gfp(end) <= 0.1*max_gfp
            ...
            %%% Calculating Metrics: "Rise time, Pulse width, Pulse height, Steady state"
